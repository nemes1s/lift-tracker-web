...
- Add new entries under an `[Unreleased]` section at the top as changes are made
- Move entries to the appropriate version section when releasing
- Use these categories: Added, Changed, Deprecated, Removed, Fixed, Security
- Reference PR numbers or commit hashes when applicable
