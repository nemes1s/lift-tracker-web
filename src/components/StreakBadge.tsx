...
export function StreakBadge({ weeks }: StreakBadgeProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div className="inline-flex items-center gap-2 px-3 py-2 rounded-lg font-semibold bg-gradient-to-r from-primary-500 to-primary-600 dark:from-primary-600 dark:to-primary-700 text-white">
